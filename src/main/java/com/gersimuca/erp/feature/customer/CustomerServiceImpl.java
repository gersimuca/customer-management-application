...
public class CustomerServiceImpl implements CustomerService {
  ...
  public Page<CustomerDto> search(
      final Status status, final Long ownerId, final String search, final Pageable pageable) {
    return repository.search(status, ownerId, normalizeSearch(search), pageable).map(mapper::toDto);
  }
